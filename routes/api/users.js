...
router.get('/', auth, async (req, res) => {
    try {
        ...
        if (users.isEmpty) return res.status(400).json({ msg: 'There are no users' });
...
// @route   POST api/users/add/superuser
// @desc    Create super user without auth [only Top Admin can do this]
// @access  private
