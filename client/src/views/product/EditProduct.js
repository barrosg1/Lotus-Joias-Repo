...
const EditProduct = ({ getProduct, editProduct, getProductCategories, deleteProduct, match, history }) => {
    ...
    }, [match, getProduct, loading, getProductCategories, product.name, product.wholesalePrice, product.retailPrice, product.wholesaler, product.description, product.purchaseDate, product.quantity, product.warrantyDate, product.maxDiscount, product.category]
    );
...
export default connect(null, { getProduct, editProduct, deleteProduct, getProductCategories })(EditProduct);
